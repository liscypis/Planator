...
public class GetNearbyPlaces extends AsyncTask<Object, Void, List> {
    ...
    protected void onPostExecute(List list) {
        ...
        NearbyJsonParser nearbyJsonParser = new NearbyJsonParser();
        nearbyPlaceList = nearbyJsonParser.parse(list);
